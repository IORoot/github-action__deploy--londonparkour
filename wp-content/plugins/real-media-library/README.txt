...
Our PRO version offers even more useful features and subfolders to help you manage your media library in WordPress. [**Learn more about the PRO version.**](https://devowl.io/go/codecanyon/real-media-library?source=wordpress-org-description)
...
**Yes, all core features of Real Media Library are free and you are able to create unlimited main folders.** You want more features like subfolders? [**Learn more about the PRO version.**](https://devowl.io/go/codecanyon/real-media-library?source=wordpress-org-description)
