...
if (!class_exists('Puc_v4p4_Vcs_GitHubApi', false)):
    class Puc_v4p4_Vcs_GitHubApi extends Puc_v4p4_Vcs_Api {
        ...
        public function getLatestCommit($filename, $ref = 'master') {
            $commits = $this->api('/repos/:user/:repo/commits', [
                'path' => $filename,
                'sha' => $ref
            ]);
        ...
        public function enableReleaseAssets($fileNameRegex = null) {
            ...
            add_filter('upgrader_pre_download', [$this, 'addHttpRequestFilter'], 10, 1); //WP 3.7+
        }
        ...
        public function addHttpRequestFilter($result) {
            ...
            if ($this->releaseAssetsEnabled && !$filterAdded && $this->isAuthenticationEnabled()) {
                add_filter('http_request_args', [$this, 'setReleaseDownloadHeader'], 10, 2);
                $filterAdded = true;
            }
            return $result;
        }
